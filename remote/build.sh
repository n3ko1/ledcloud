...
~/dev/kivy/android/python-for-android/dist/default/build.py --dir ~/dev/electro/arduino/kivy --package org.arduino.ledcloud --name "LED Cloud Remote Control" --version 0.1 --orientation landscape --permission INTERNET debug installd;